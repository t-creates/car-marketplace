...
const Navbar = () => {
  ...
  return (
    <div className={`shadow-lg w-full fixed top-0 left-0 h-[60px] ${router.query.id? 'bg-indigo-600': 'bg-[#A5A8Ac]' } z-10`}>
      ...
      <div  className='text-3xl absolute right-8 top-2 cursor-pointer bg-transparent scale-125 md:hidden '>
        <MenuOutlinedIcon
